...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.5189}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.4811}}@{}}
\toprule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\begin{center}
\includegraphics[width=3.72917in,height=\textheight]{images/2025-08-18/04-Donald_Chamberlain.jpg}

\textbf{Donald Chamberlain} - Criador da linguagem SQL nos laboratórios da IBM
\end{center}
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
\begin{center}
\includegraphics[width=2.47917in,height=\textheight]{images/2025-08-18/04-Raymond_Boyce.jpg}

\textbf{Raymond Boyce} - Criador da linguagem SQL nos laboratórios da IBM
\end{center}
\end{minipage} \\
\end{longtable}
