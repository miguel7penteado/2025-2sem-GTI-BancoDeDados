...
Para tratar problemas desta natureza, o professor em matemática da Universidade do Tenesse, [Prof Edgar Frank Codd (1923-2003)](https://pt.wikipedia.org/wiki/Edgar_Frank_Codd) procurou inicialmente utilizar teorias matemáticas para organizar e oferecer consistência aos dados:
...
A limitação deste modelo logo apareceria: a forma matemática não conseguia representar os diferentes atributos que distinguiam cada elemento existente dentro de um conjunto.

### Modelo Lógico: Modelo Entidade Relacionamento

em 1978 , o professor **Peter Pin-Shan Chen** da universidade norte-americana de Luisiania apresentou o Modelo Entidade Relacionamento. Este modelo apresentava uma forma de modelar projetos de Bancos de Dados relacionais, independemente de plataforma tecnológica ( UNIX, Windows etc).

#### Modelo Entidade Relacionamento

O modelo Entidade Relacionamento, também chamado de MER, consistem em traduzir um texto para um modelo de Banco de dados utilizando a morfologia da gramática da língua portuguesa com a seguinte regra:
